...
describe('Template Engine', function() {
    ...
    it('can use stacked template', function () {
    ...
    it('can used by template', function() {
        ...
        $this->template->setGlobals(array(
            'foo' => 'FoO',
        ...
        })->to->throw('BadFunctionCallException', 'Function is not found at any context: unknown.');
        ...
        })->to->throw('LogicException', 'Section name is reserved: content.');
        ...
        })->to->throw('LogicException', "Template not found: 'unknown'.");

        expect(function() {
            $this->template->getTemplateDirectories('namespace:unknown');
        })->to->throw('LogicException', "Directory not exists for template: 'namespace:unknown'.");

        expect(function() {
            $this->template->chain('foo', 'chain');
        })->to->throw('LogicException', "Recursive chain is not supported.");
    });
